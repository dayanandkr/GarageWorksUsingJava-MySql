...
public class Update_id extends javax.swing.JFrame {
    ...
    void update_id(){
                try{
            String new_id=t1.getText();
            String new_id2=t2.getText();
            
            if(new_id.equals(new_id2)){
                
              Db_Connection.ConectionDb.st.executeUpdate("update admin_login set id='"+new_id+"'");
                JOptionPane.showMessageDialog(null," Id Updated Successfully!"); 
                dispose();
            }
            else{
                JOptionPane.showMessageDialog(null," Both id are not same !");    
            }
    ...
    private void initComponents() {
        ...
        setTitle("GarageWorks[Update  id]");
        setResizable(false);
        ...
        jLabel3.setText("Enter id  again:");
